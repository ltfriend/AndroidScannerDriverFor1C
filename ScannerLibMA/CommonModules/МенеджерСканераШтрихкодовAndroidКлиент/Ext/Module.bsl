...
Процедура Подключить(ИдентификаторКлиента) Экспорт
	...
	Иначе
		глПараметрыСканераШтрихкодовAndroid.Клиенты.Добавить(ИдентификаторКлиента);
		
		КоличествоПодключенных = глПараметрыСканераШтрихкодовAndroid.КоличествоПодключенных;
		глПараметрыСканераШтрихкодовAndroid.КоличествоПодключенных = КоличествоПодключенных + 1;
	КонецЕсли; 
